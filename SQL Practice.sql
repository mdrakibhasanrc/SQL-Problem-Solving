...
select  FIRST_NAME, rtrim(FIRST_NAME) as Clean_Name
from worker;
...
select FIRST_NAME,
       replace(FIRST_NAME,'a','A') as New_Name
from worker;
...
/* Q-37. Write an SQL query to fetch the first 50% records from a table.*/
...
/* Q-38. Write an SQL query to fetch the departments that have less than five people in it.*/
...
/* Q-39. Write an SQL query to fetch the names of workers who earn the highest salary.*/
